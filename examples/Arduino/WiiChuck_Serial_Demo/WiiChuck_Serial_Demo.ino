...
void loop() {
	...
	if (myChuck.type == WIICLASSIC) {
		...
		sprintf(st,
				...
				myChuck.leftStickX(), myChuck.leftStickY());
		...
		Serial.println("Currently Unsupported controller type ");
		switch(myChuck.type){
		case NUNCHUCK:
			Serial.println("NUNCHUCK");
			break;
		case WIICLASSIC:
			Serial.println("WIICLASSIC");
			break;
		case GuitarHeroController:
			Serial.println("GuitarHeroController");
			break;
		case GuitarHeroWorldTourDrums:
			Serial.println("GuitarHeroWorldTourDrums");
			break;
		case DrumController:
			Serial.println("DrumController");
			break;
		case DrawsomeTablet:
			Serial.println("DrawsomeTablet");
			break;
		case Mystery:
			Serial.println("Mystery");
			break;
		}
